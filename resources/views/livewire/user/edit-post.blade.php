                ...
                <div class="col-12 col-md-12 col-lg-8 mt-0 mb-3">
                    <div class="card shadow text-center" style="border-left: 4rem solid #1c2540;">
                        ...
                        <div class="card-footer bg-white border-0">
                            <button wire:click="updatePost" type="button" class="btn btn-secondary">
                    ...
                    <div class="card shadow text-center mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <button wire:click="updateCover" class="btn btn-sm btn-primary"
                                        type="button">Badil</button>
                                </div>
                            </div>
                            @error('thumbnail')
                                <div class="text-danger">{{ $message }}</div>
                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-1">
                                                    <span wire:click="removeTag({{ $loop->index }})"
                                                        class="fas fa-minus text-danger" style="cursor: pointer"></span>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
