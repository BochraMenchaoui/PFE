...
<div class="title">
    <h3>Ettounsi,
        <span class="txt-rotate" data-period="2000"
            data-rotate='[ "nhebouh.", "loughtna.", "asslna.", "msh aarbi mkassr.", "ena w enty w lkolna!" ]'></span>
    </h3>
</div>
<div class="more-pens">
    <a target="_blank" href="{{ route('login') }}" class="white-mode">Connecti</a>
    <a target="_blank" href="{{ route('sign-up') }}" class="white-mode">9ayed</a>
</div>
...
<script>
    ...
    writeText(c2.canvas, c2.context, "DERJA")
    ...
    function writeText(canvas, context, text) {
        ...
        for (let i = 0; i < lines.length; i++) {
            context.fillText(lines[i], canvas.width / 2, canvas.height / 2 + lineheight * i - (lineheight * (lines
                .length - 1)) / 3);
        }
    }
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                                    class="underline text-gray-900 dark:text-white">{{ __('Documentation') }}</a>
                            </div>
                        </div>
